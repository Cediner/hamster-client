...
public class Entry extends Widget {
    ...
    public static final Tex male   = Loading.waitfor(Resource.remote().load("gfx/hud/rosters/male", 2)).layer(Resource.imgc).tex();
    public static final Tex female = Loading.waitfor(Resource.remote() .load("gfx/hud/rosters/female", 2)).layer(Resource.imgc).tex();
    public static final Function<Boolean, Tex> sex = v -> (v ? male : female);
    public static final Tex adult = Loading.waitfor(Resource.remote().load("gfx/hud/rosters/adult", 2)).layer(Resource.imgc).tex();
    public static final Tex child = Loading.waitfor(Resource.remote().load("gfx/hud/rosters/child", 2)).layer(Resource.imgc).tex();
    public static final Function<Boolean, Tex> growth = v -> (v ? child : adult);
    public static final Tex dead  = Loading.waitfor(Resource.remote().load("gfx/hud/rosters/dead", 2)).layer(Resource.imgc).tex();
    public static final Tex alive = Loading.waitfor(Resource.remote().load("gfx/hud/rosters/alive", 2)).layer(Resource.imgc).tex();
    public static final Function<Boolean, Tex> deadrend = v -> (v ? dead : alive);
    public static final Tex pregy = Loading.waitfor(Resource.remote().load("gfx/hud/rosters/pregnant-y", 2)).layer(Resource.imgc).tex();
    public static final Tex pregn = Loading.waitfor(Resource.remote().load("gfx/hud/rosters/pregnant-n", 2)).layer(Resource.imgc).tex();
